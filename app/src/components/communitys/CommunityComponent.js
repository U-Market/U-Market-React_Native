...
const CommunityComponent = ({ navigation }) => {
  ...
  const _handelCommunitySearchPage = () => {
    navigation.navigate("CommunitySelectPage");
  };
  ...
  return (
    <Container>
      <MainTop>
        ...
        <SearchContainer onPress={_handelCommunitySearchPage}>
          <SearchInput>
      ...
      <CommunityCategory navigation={navigation} />
    </Container>
  );
};
